import type { ClientData, InvoiceData } from "./client-dashboard-types";

export function printInvoice(inv: InvoiceData, client: ClientData) {
        ...
        <div class="invoice-container">
          ...
          <div class="grid-details">
            <div class="details-block">
              ...
              <p>Address: ${inv.subtotal > 0 ? client.billingAddress || "—" : "—"}</p>

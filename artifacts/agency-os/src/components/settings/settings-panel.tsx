...
export function SettingsPanel({ settings }: { settings: Settings }) {
  ...
  return (
    <Tabs defaultValue="branding" className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <TabsList className="flex flex-row lg:flex-col h-auto w-full bg-card border border-border/80 rounded-xl p-1.5 shrink-0 space-y-0 lg:space-y-1 overflow-x-auto lg:overflow-x-visible justify-start gap-1 lg:gap-0 scrollbar-none shadow-2xs">
          ...
          >
            ...
            <div className="hidden lg:block text-left truncate">
              <div className="font-semibold text-xs leading-none">Branding</div>
              <div className="text-[10px] opacity-80 font-normal mt-1 truncate">Colors & company domain</div>
            </div>
          ...
          >
            ...
            <div className="hidden lg:block text-left truncate">
              <div className="font-semibold text-xs leading-none">Finance & Tax</div>
              <div className="text-[10px] opacity-80 font-normal mt-1 truncate">GST & default rates</div>
            </div>
            <span className="lg:hidden whitespace-nowrap">Finance</span>
          </TabsTrigger>
          ...
          >
            ...
            <div className="hidden lg:block text-left truncate">
              <div className="font-semibold text-xs leading-none">Security</div>
              <div className="text-[10px] opacity-80 font-normal mt-1 truncate">Session & check-in rules</div>
            </div>
          ...
          >
            ...
            <div className="hidden lg:block text-left truncate">
              ...
              <div className="text-[10px] opacity-80 font-normal mt-1 truncate">API keys & social publishing</div>
            </div>
          ...
          >
            ...
            <div className="hidden lg:block text-left truncate">
              ...
              <div className="text-[10px] opacity-80 font-normal mt-1 truncate">Alerts & notification preferences</div>
            </div>

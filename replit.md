...
- Required env: `NEON_DATABASE_URL` — Neon Postgres connection string (set as a Replit Secret); takes priority over the legacy `SUPABASE_DATABASE_URL` and Replit-managed `DATABASE_URL`
